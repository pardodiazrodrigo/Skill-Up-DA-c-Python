...
with DAG(
    ...
    def extract():
        ...
        try:
            ...
            df.to_csv("files/3IUNJujuy_select.csv")
    ...
    def transform():
        ...
        try:
            ...
            # DF Universidad
            with open("files/3IUNJujuy_select.csv") as f:
            ...
            # Created Files
            df.to_csv("datasets/3IUNJujuy_process.txt",sep="\t",index=None)
    ...
    def load():
        ...
        try:
            ...
            data = open("datasets/3IUNJujuy_process.txt", "rb")
