...
with DAG (
    ...
    def extract():
        ...
        try:
            with open("include/3DUNUTN.sql" ,"r") as sqlfile:
                query = sqlfile.read()
            hook = PostgresHook(postgres_conn_id="alkemy_db")
            df = hook.get_pandas_df(sql=query)
            df.to_csv("files/3DUNUTN_select.csv", index=False)
    ...
    def transform():
        ...
        try:
            with open("files/3DUNUTN_select.csv", "r", encoding="utf-8") as my_file:
            ...
            #################################### EXPORTACION txt ##############################################
            df.to_csv("datasets/3DUNUTN_process.txt", sep="\t", index=None)
    ...
    def loads3():
        ...
        try:
            ...
            data = open("datasets/3DUNUTN_process.txt", "rb")
